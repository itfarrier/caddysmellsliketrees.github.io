        ...
        <article className={styles.article}>
            <section className={styles.section}>
                ...
                <p className={styles.p}>
                    In&nbsp;February 2015, our grains fell into unknown land, and by&nbsp;October
                    the first sprouts appeared. Fruits we&nbsp;bloom slowly, but our branches grow
                    stronger and are filled with juice ever thicker and spicier!
                </p>
                <p className={styles.p}>
                    We&nbsp;play soul&#8208;helpful songs for every day. They are merging
                    in&nbsp;our forests in&nbsp;such a&nbsp;way that it&nbsp;is&nbsp;difficult
                    to&nbsp;separate them from each other, and between them bellow bold deer poems.
                </p>
            </section>
            <section className={styles.section}>
                ...
                <ul className={styles.ul}>
                    ...
                    <li>
                        Svetlana Podabed
                        <br />
                        (wind, guitar, vocal, background vocal, declamation of lyrics, percussion)
                    </li>
                    <li>
                        Sergej Nefed'ev
                        <br />
            ...
            <section className={styles.section}>
                <h1 className={styles.h1}>
                    <a className={styles.a} href="/documents/technicalRider.pdf">
                        ...
                        <img alt="PDF logo" className={styles.pdfImg} src="/vectors/filePdf.svg" />
                    </a>
                </h1>
            </section>
        </article>
