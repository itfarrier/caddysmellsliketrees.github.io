    ...
    <React.Fragment>
        ...
        <article className={styles.article}>
            <section className={styles.section}>
                <h1 className={styles.h1}>Эта группа&thinsp;&mdash;&thinsp;наш деревянный сруб</h1>
                ...
                <p className={styles.p}>
                    ...
                    в&nbsp;леса так, что их&nbsp;тяжело отделить друг от&nbsp;друга, а&nbsp;между
                    ними бликуют смелыми оленями стихи.
                </p>
            </section>
            <section className={styles.section}>
